...
/**
 * Client component for checkout complete page.
 * Uses next/navigation hooks and fetches the order via /api/orders?id=...
 */
      ...
      <header className="mb-8">
        <div className="rounded-lg bg-green-50 p-8">
          ...
          <div className="mt-6 flex gap-4">
            ...
            {/* admin/orders link intentionally removed so orders aren't publicly discoverable */}
          </div>
        </div>
      </header>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="rounded-lg border p-6 bg-white">
            <div className="flex items-start justify-between">
              <div>
                <strong>Order ID:</strong> <span className="text-indigo-700">{id || "—"}</span>
              </div>
